...
public class AORSlot extends Slot
{
	...
	public AORSlot(EntityPlayer player, IInventory inv, int par3, int par4, int par5)
	{
	...
	{
		itemStack.onCrafting(thePlayer.worldObj, thePlayer, field_75228_b);

		if (!thePlayer.worldObj.isRemote)
		{
			int var2 = field_75228_b;
			float var3 = FurnaceRecipes.instance().getSmeltingExperience(itemStack);
			int var4;
