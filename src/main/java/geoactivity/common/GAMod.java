...
public class GAMod
{
	...
	public static ItemArmor.ArmorMaterial ReinforcedArmorMaterial = EnumHelper.addArmorMaterial("ReinforcedArmor",
			"geoactivity:reinforced", 30, new int[]{ 2, 6, 5, 2 }, 18, SoundEvent.soundEventRegistry.getObject(new ResourceLocation("item.armor.equip_generic")));
	public static ItemArmor.ArmorMaterial AdvancedArmorMaterial = EnumHelper.addArmorMaterial("AdvancedArmor",
			"geoactivity:advanced", 35, new int[]{ 4, 10, 7, 4 }, 8, SoundEvent.soundEventRegistry.getObject(new ResourceLocation("item.armor.equip_generic")));
